...
class IssuesController < ApplicationController
  ...
  def index
    ...
    if @query.valid?
      ...
      respond_to do |format|
        ...
        format.xml  { render :xml => @issues.to_xml(:except => [:created_on, :updated_on]) }
      end
    else
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.xml  { render :xml => @issue.to_xml(:except => [:created_on, :updated_on], :include => [:journals, :attachments, :time_entries, :changesets]) }
    end
  end
