...
Redmine::AccessControl.map do |map|
  ...
  map.project_module :issue_tracking do |map|
    ...
    map.permission :delete_issues, {:issues => [:destroy, :bulk_destroy]}, :require => :member
    # Queries
    map.permission :manage_public_queries, {:queries => [:new, :create, :edit, :create, :destroy]}, :require => :member
    map.permission :save_queries, {:queries => [:new, :create, :edit, :upate, :destroy]}, :require => :loggedin
    # Gantt & calendar
  ...
  map.project_module :documents do |map|
    map.permission :manage_documents, {:documents => [:new, :create, :edit, :update, :destroy, :add_attachment, :destroy_attachment]}, :require => :loggedin
  ...
  map.project_module :wiki do |map|
    ...
    map.permission :edit_wiki_pages, :wiki => [:edit, :update, :preview, :add_attachment, :destroy_attachment]
